...
class ClientPubSub {
  companion object {
    ...
    fun stop(client: DaprClient): Mono<Void> {
      return client.publishEvent(PUB_SUB_NAME, STOP_TOPIC_NAME, Unit)
    }
  }

  var startTime: Instant? = null

  @Topic(name = ArbitratorPubSub.START_TOPIC, pubsubName = ArbitratorPubSub.PUB_SUB_NAME)
  @PostMapping("/start")
  fun startSubscriber() {
